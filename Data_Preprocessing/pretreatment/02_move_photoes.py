...
if __name__ == "__main__":
    # 源文件夹路径（包含99个子文件夹的目录）
    source_directory = r"F:\Microalgae_Photoes\20260214\L100-320-350-400.COM.3"  # 替换为实际源目录路径

    # 目标父目录（将在其中创建以图片名为基础的子文件夹）
    target_parent_directory = r"F:\Microalgae_Photoes\20260214\CH3"  # 替换为实际目标目录路径
