...
CHAMBER_BORDER_MAX_RATIO = 0.10
ENABLE_TINY_INSTANCE_FILTER = True
TINY_INSTANCE_ABS_AREA = 400
...
CHAMBER_BORDER_TOUCH_MIN_INSIDE_RATIO = 0.18
    ...
    with pd.ExcelWriter(excel_path, engine="openpyxl") as writer:
        ...
        for image_path in tqdm(images):
            ...
            try:
                ...
                mask_only = overlay_chamber_boundary(mask_only, proc["chamber_mask"])
                mask_with_ids = overlay_instances(original_img, merged_instances, show_labels=True, show_boxes=False)
                mask_with_ids = overlay_chamber_boundary(mask_with_ids, proc["chamber_mask"])
                stats_lines = [
