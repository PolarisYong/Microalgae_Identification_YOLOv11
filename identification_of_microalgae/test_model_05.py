...
# -*- coding: utf-8 -*-
"""
@File    : test_model_05.py
@Time    : 2025/10/2 17:35
@Author  : Pan Yong
...
# 对于没有识别到微藻细胞的图片也生成相关结果图片，并保存到结果统计表中
# 加载预训练模型
model = YOLO(r'E:\pythonProject\Microalgae_Identification_YOLOv11\runs\segment\train2\weights\best.pt')
...
# 指定要处理的文件夹路径
folder_path = r'F:\Microalgae_Photoes\20251002\Processed\001_L100_20\IMG001x001'
