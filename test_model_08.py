...
import os
import shutil  # 新增：用于删除已存在的results文件夹
...
# 指定要处理的文件夹路径
# folder_path = r'F:\Microalgae_Photoes\20251002\Processed\004_L100_300\IMG001x012'
# process_folder(folder_path)

# 示例: 处理多个子文件夹（若有需要可取消注释使用）
root_folder = r'F:\Microalgae_Photoes\20251002\Processed\004_L100_300'
